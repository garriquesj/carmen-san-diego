...
--table is country language attribute is countrycode which is VAT
...
-- Clue #4: We're booking the first flight out – maybe we've actually got a chance to catch her this time.
 ...
 --  be flying to.
so search cities  but not the one that is the same as the countryies name sthe countries cities???
...
-- so Need a search for similar command
...
-- Clue #7: She knows we're on to her – her taxi dropped her off at the international airport, and she beat us to
 ...
 -- landing dock.
match city or country to number?
...
FROM city WHERE population = 91084;
  id  |     name     | countrycode |  district  | population 
------+--------------+-------------+------------+------------
 4060 | Santa Monica | USA         | California |      91084
(1 row)

-- She's in _________Santa Monica_____________!
